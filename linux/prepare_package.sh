...
mkdir --mode=755 yoctovisualization/usr/share/icons/hicolor/16x16/app
mkdir --mode=755 yoctovisualization/usr/share/icons/hicolor/32x32
mkdir --mode=755 yoctovisualization/usr/share/icons/hicolor/32x32/app
mkdir --mode=755 yoctovisualization/usr/share/icons/hicolor/48x48
mkdir --mode=755 yoctovisualization/usr/share/icons/hicolor/48x48/app
mkdir --mode=755 yoctovisualization/usr/share/icons/hicolor//128x128
mkdir --mode=755 yoctovisualization/usr/share/icons/hicolor//128x128/app
mkdir --mode=755 yoctovisualization/usr/share/icons/hicolor/256x256
mkdir --mode=755 yoctovisualization/usr/share/icons/hicolor/256x256/app
mkdir --mode=755 yoctovisualization/usr/share/icons/hicolor/scalable
mkdir --mode=755 yoctovisualization/usr/share/icons/hicolor/scalable/app
...
cp ../artwork/icon.svg yoctovisualization/usr/share/icons/hicolor/scalable/app/YoctoVisualization.svg
