                ...
                if (File.Exists(dll_path)) {
                    try {
                        ...
                        if (loadLibrary == IntPtr.Zero) {
                            ...
                            debugDll("Try to map function to shared lib");
                            mapYAPIFunctions();
                            debugDll("Function mapped to shared lib");
                            return 0;
                        }
...
public class YAPI
{
    ...
    public const string YOCTO_API_BUILD_NO = "71843";
