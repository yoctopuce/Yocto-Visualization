...
namespace YoctoVisualisation
{
    class constants
    {
        public static string buildVersion = "72996";
        ...
        public static void init(String[] args)
        {
            ...
            if (!configFileOverride) CheckForPreviousConfig();
        }

        private static void CheckForPreviousConfig()
        {
            if (!File.Exists(_configfile)) {
                ...
                DirectoryInfo[] directories = dir.GetDirectories("2.*.*.*");
                int max_build = 0;
                string previous = "2.0.0.0";
                foreach (DirectoryInfo dirinfo in directories) {
                    ...
                    try {
                        ...
                        int buildno = minor * 60000 + b;
                        if (buildno > max_build) {
                            max_build = buildno;
